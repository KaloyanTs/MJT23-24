...
public class IntelligentHomeCenter {
    ...
    public void register(IoTDevice device) throws DeviceAlreadyRegisteredException {
        ...
        if (storage.exists(device.getId())) {
            throw new DeviceAlreadyRegisteredException("given device already registered...");
        }
    ...
    public void unregister(IoTDevice device) throws DeviceNotFoundException {
        ...
        if (!storage.exists(device.getId())) {
            throw new DeviceNotFoundException("Cannot unregister device, which is not registered...");
        }
...
//		{
//			long hoursFirstDevice = Duration.between(firstDevice.getInstallationDateTime(),
//			LocalDateTime.now()).toHours();
//			long hoursSecondDevice = Duration.between(secondDevice.getInstallationDateTime(),
//			LocalDateTime.now()).toHours();
